Feature: A set of scenarios for testing the "example" module
  ...
  Scenario Outline: Student tries to change choice after the teacher disables updates
    # the student answers the choice test for the first time
    ...
    # the teacher disables updates for the choice test
    ...
    # the student tries to change his choice, but he can't
