...
6. We recorded a video of the running tests and added it to the report. Since more than one browser session was opened, we recorded the entire screen. The link for the video is [here](submission-files/recordedRun.mp4).
...
**if you want to test a suit of X tests make sure there is at X one comment of the name "hey1"**